...
- `design-system/ai-doctor-voice/MASTER.md` — Global Source of Truth with all design rules
...
3. If not, use `design-system/ai-doctor-voice/MASTER.md` exclusively
...
```bash
python .agent/skills/ui-ux-pro-max/scripts/search.py "beauty spa wellness service elegant" --design-system -p "Serenity Spa"
```
...
```bash
python .agent/skills/ui-ux-pro-max/scripts/search.py "layout responsive form" --stack html-tailwind
```
...
python .agent/skills/ui-ux-pro-max/scripts/search.py "fintech crypto" --design-system

# Markdown - best for documentation
python .agent/skills/ui-ux-pro-max/scripts/search.py "fintech crypto" --design-system -f markdown
```
